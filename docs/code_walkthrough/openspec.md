...
`openspec/` is an OpenSpec workspace — a spec-driven workflow for proposing, designing, and tracking changes. It is metadata, not code. The repo uses it and `docs/superpowers/` (design specs / execution plans).
