...
- [x] 10.4 Compare recorded plans with the pathway in `docs/research/2026-09-05-pathway-plan-delta.md`; record reused, amended, added and deferred scope, including the user-directed DBOS interface/stub direction and minimal first-pass deep-module design. Production specs and implementation tasks remain unchanged; the SDK runtime requirement needs a separate amendment.
- [x] 10.5 Add a resumable agent-login section to the pathway: deep authentication module, explicit first-pass stub, later browser-assisted adapter, protected credentials and cross-process acceptance. This is design direction only; auth implementation and normative SDK amendments remain separate work.
